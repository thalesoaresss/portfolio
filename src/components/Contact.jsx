...
const socialLinks = [
  ...
  },
  {
    ...
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 2.045C6.504 2.045 2.045 6.504 2.045 12c0 1.977.523 3.899 1.517 5.58L2 22l4.482-1.517c1.682.994 3.604 1.517 5.58 1.517 5.496 0 9.955-4.459 9.955-9.955C21.955 6.504 17.496 2.045 12 2.045zm0 17.863c-1.705 0-3.363-.456-4.818-1.318L5.845 19.155l1.566-1.568C5.713 16.51 5.29 14.773 5.29 12.96c0-4.03 3.284-7.315 7.313-7.315 4.03 0 7.315 3.285 7.315 7.315 0 4.029-3.284 7.314-7.315 7.314zm4.104-5.059c-.254-.127-1.505-.743-1.736-.828-.233-.085-.402-.126-.571.126-.168.253-.656.828-.803.996-.147.169-.296.191-.55.064-.256-.127-1.082-.402-2.061-1.282-.761-.67-1.276-1.5-1.429-1.755-.147-.254-.015-.391.111-.519.114-.113.253-.296.381-.441.129-.146.171-.253.256-.422.084-.168.042-.317-.021-.444-.063-.127-.571-1.381-.781-1.883-.205-.493-.414-.425-.571-.432-.15-.006-.318-.008-.486-.008-.166 0-.439.064-.668.253-.23.19-.876.856-.876 2.096s.897 2.43 1.024 2.597c.127.169 1.762 2.66 4.277 3.73.598.25 1.067.397 1.43.507.601.191 1.147.165 1.579.1.482-.072 1.506-.613 1.721-1.203.215-.591.215-1.099.15-1.203-.063-.105-.232-.168-.485-.296z" fill="currentColor" />
        </svg>,
    alt: 'Whatsapp'
  },
  {
      ...
      <section className="section" id="contact">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
          <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
            ...
            <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">Entre em contato hoje para conversar sobre as necessidades do seu projeto e começar a trabalhar juntos em algo incrível!</p>
          ...
          <form action="https://getform.io/f/blllrymb" method="POST" className="xl:pl-10 2xl:pl-20">

            <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
              <div className="mb-4">
                <label htmlFor="name" className="label">Nome</label>
                <input type="text" name="name" id="name" autoComplete="name" required placeholder="Digite seu nome" className="text-field" />
              </div>

              <div className="mb-4">
                <label htmlFor="email" className="label">Email</label>
                <input type="email" name="email" id="email" autoComplete="email" required placeholder="Digite seu email" className="text-field" />
              </div>
            </div>

            <div className="mb-4">
              <label htmlFor="message" className="label">Mensagem</label>
              <textarea name="message" id="message" placeholder="Olá!" required className="text-field resize-y min-h-32 max-h-80"></textarea>
            </div>

            <button type="submit" className="btn btn-primary [&]:max-w-full w-full justify-center">Enviar</button>
